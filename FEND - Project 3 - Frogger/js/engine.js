        ...
        case "startGame":
            ...
            for (row = 0; row < numRows; row++) {
                for (col = 0; col < numCols; col++) {
                    ...
                    ctx.fillText("Let's Play Frogger!", canvas.width/2, canvas.height/5.6);
                    ctx.fillStyle = "black";
                    ctx.font = "40px Arial";
                    ctx.textAlign = "center";
                    ctx.fillText("Press Enter To Start", canvas.width/2, canvas.height/2.25);
                    ctx.fillStyle = "blue";
                    ctx.font = "20px Arial";
                    ctx.textAlign = "center";
                    ctx.fillText("Use the arrow keys to move", canvas.width/2, canvas.height/1.5);
                    ctx.fillText("Go beyond the water to score - gems are more points", canvas.width/2, canvas.height/1.42);
                    ctx.fillText("Difficulty increases after every score", canvas.width/2, canvas.height/1.35);
                    ctx.fillText("Hearts are extra lives", canvas.width/2, canvas.height/1.29);
                    ctx.fillText("Bugs make you lose lives", canvas.width/2, canvas.height/1.23);
                    ctx.fillStyle = "red";
                    ctx.font = "40px Arial";
                    ctx.textAlign = "center";
                    ctx.fillText("Good Luck!", canvas.width/2, canvas.height/1.1);
                }
            }
            break;
        case "inGame":
